...
func main() {
	...
	//replayChaincodeEvents(ctx, network, 0, chaincodeName)
}
...
func transferAssetAsync(contract *client.Contract) {
	...
	//contract.SubmitWithContext()
	submitResult, commit, err := contract.SubmitAsync("set", client.WithArguments("Mark", "1333"),
		client.WithEndorsingOrganizations("Node1MSP", "Node2MSP"))
	if err != nil {
...
func hll(contract *client.Contract) {

	//p, err := contract.NewProposal("set", client.WithArguments("Mark", "1333"))
	//if err != nil {
	//	panic(err)
	//}
	//
