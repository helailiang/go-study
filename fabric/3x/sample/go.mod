...
replace github.com/hyperledger/fabric-protos-go v0.3.0 => github.com/hyperledger/fabric-protos-go v0.0.0-20200707132912-fee30f3ccd23

//replace  github.com/Shopify/sarama v1.43.3 => github.com/IBM/sarama
